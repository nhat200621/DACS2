...
exports.Connector = core.serialization.object({
    ...
    authStatus: core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).ConnectorAuthStatus; })).optional(),
