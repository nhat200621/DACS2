...
const Client_1 = require("./api/resources/connectors/client/Client");
class CohereClient {
    ...
    get connectors() {
        var _a;
        return ((_a = this._connectors) !== null && _a !== void 0 ? _a : (this._connectors = new Client_1.Connectors(this._options)));
    }
