...
exports.CreateRequest = core.serialization.object({
    ...
    serviceAuth: core.serialization
        .lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../../..")))).CreateConnectorServiceAuth; }))
        .optional(),
});
